 ...
 */
public class GenerateSetterInvocationsDialog {

    private static final String X = "GenerateSetterInvocationsDialogX"; //NOI18N
    private static final String Y = "GenerateSetterInvocationsDialogY"; //NOI18N
    private static final String WIDTH = "GenerateSetterInvocationsDialogWidth"; //NOI18N
    private static final String HEIGHT = "GenerateSetterInvocationsDialogHeight"; //NOI18N
    private static final int DEFAULT_WIDTH = 300;
    private static final int DEFAULT_HEIGHT = 300;
    private final Dialog dialog;
    private final DialogDescriptor dialogDescriptor;

    private GenerateSetterInvocationsDialog(LocalMembersAndVarsPanel localMembersAndVarsPanel) {
        dialogDescriptor = new DialogDescriptor(
                localMembersAndVarsPanel,
                NbBundle.getMessage(GenerateSetterInvocationsDialog.class, "DN_Generate_Setter_Invocations")); //NOI18N
    ...
    public static GenerateSetterInvocationsDialog createAndShow(LocalMembersAndVarsPanel localMembersAndVarsPanel) {
        return new GenerateSetterInvocationsDialog(localMembersAndVarsPanel);
    }
    ...
    private Rectangle getBounds() {
        Preferences preferences = NbPreferences.forModule(GenerateSetterInvocationsDialog.class);
