 ...
 */
public class GenerateOtherMethodInvocationsDialog {

    private static final String X = "GenerateOtherMethodInvocationsDialogX"; //NOI18N
    private static final String Y = "GenerateOtherMethodInvocationsDialogY"; //NOI18N
    private static final String WIDTH = "GenerateOtherMethodInvocationsDialogWidth"; //NOI18N
    private static final String HEIGHT = "GenerateOtherMethodInvocationsDialogHeight"; //NOI18N
    private static final int DEFAULT_WIDTH = 300;
    private static final int DEFAULT_HEIGHT = 300;
    private final Dialog dialog;
    private final DialogDescriptor dialogDescriptor;

    private GenerateOtherMethodInvocationsDialog(LocalMembersAndVarsPanel localMembersAndVarsPanel) {
        dialogDescriptor = new DialogDescriptor(
                localMembersAndVarsPanel,
                NbBundle.getMessage(GenerateOtherMethodInvocationsDialog.class, "DN_Generate_Other_Method_Invocations")); //NOI18N
    ...
    public static GenerateOtherMethodInvocationsDialog createAndShow(LocalMembersAndVarsPanel localMembersAndVarsPanel) {
        return new GenerateOtherMethodInvocationsDialog(localMembersAndVarsPanel);
    }
    ...
    private Rectangle getBounds() {
        Preferences preferences = NbPreferences.forModule(GenerateOtherMethodInvocationsDialog.class);
